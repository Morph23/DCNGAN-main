# DCNGAN
DCNGAN: A GAN with Deformable Convolution and QP Adjustment for Enhancing the Visual Quality of Compressed Videos
...
Using LMDB files can speed up IO during training.
